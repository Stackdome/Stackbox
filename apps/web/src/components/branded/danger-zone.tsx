 ...
 *
 * §10's words apply: say what will break, in plain words, such as *"All
 * requests using this key will start failing"*, leaving "cannot be undone" to
 * the confirm behind it.
 */
