  ...
  render: () => (
    <div className="flex w-[420px] flex-col gap-6">
      ...
      <div className="flex flex-col items-center gap-3 py-8 text-center">
        <p className="text-body font-medium text-foreground">No provider connected</p>
        <p className="text-meta text-fg-muted">
          Connect GitHub or GitLab to browse the repositories you can deploy from.
        </p>
        <Button variant="outline">Connect a provider</Button>
      </div>
    </div>
  ),
  play: async ({ canvas }) => {
