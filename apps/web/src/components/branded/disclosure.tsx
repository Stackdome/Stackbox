 ...
 * fields of the same subject, such as `Advanced: build & push` or `Advanced:
 * stackfile and image overrides`. Giving those a section's chrome draws a
 * full-width rule across the panel to hide four inputs, and gives one group a
 * second group's frame.
 *
 * | | |
 * |---|---|
 ...
 * field you want is behind it is to open it. Say what is in there, as in
 * `Advanced: build & push`. The colon is the pattern: the word people scan for,
 * then the contents.
 */
