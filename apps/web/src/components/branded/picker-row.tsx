  ...
  return (
    <Element
      ...
      className={cn(
        ...
        //
        // WCAG exempts a disabled *control*, and a row carrying its reason
        // inline is one, but the words on it are the entire point of showing
        // it at all, and §7 gives no tier a discount. A tier drop reads as
        // "off" and stays readable; an alpha drop reads as "off" and stops
        // being text.
    ...
    >
      <span
        ...
        className={cn(
          ...
          // Dark takes the rung above `--control` instead, so both themes read
          // as one move: the row washes, the chip steps up off it.
          //
