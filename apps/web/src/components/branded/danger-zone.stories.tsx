...
export const OneAct: Story = {
  args: {
    children: (
      <DangerZoneRow
        ...
        description="Pull requests stop getting instances."
        action={removeButton}
      />
    ),
  },
  play: async ({ canvas }) => {
    ...
    // Fill, no border: §7 says the fill carries the tone alone.
    ...
    children: (
      <>
        ...
        <DangerZoneRow
          ...
          description="Every instance, secret and cluster in it stops serving."
          action={
            <Button variant="destructive-ghost" shape="flat">
              Delete workspace
            </Button>
  ...
  args: {
    children: (
      <DangerZoneRow
        ...
        description="Pull requests stop getting instances."
        action={
          <BlockedAction reason="Delete this repository's 3 instances first">
            {removeButton}
          </BlockedAction>
        }
      />
