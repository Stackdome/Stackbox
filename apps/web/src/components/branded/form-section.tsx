 ...
 *
 * `actions` is right-aligned on the same row as the label.
 *
...
export function FormSection({
  ...
  return (
    ...
    <div
      className={cn(
        // **The section owns its inset; the body owns none.** A section that
        // pays its own inset needs no cancelling, and the rule reaches the
