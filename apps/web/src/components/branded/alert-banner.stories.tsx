...
const meta = {
  ...
  tags: ['ai-generated'],
  args: { children: 'Release failed: image pull backoff on web-1.' },
  decorators: [
    (Story) => (
...
export const Info: Story = {
  args: {
    tone: 'info',
    children: 'Host port bindings were ignored. Stackbox assigns the route itself.',
...
export const EveryTone: Story = {
  render: () => (
    <div className="flex flex-col gap-3">
      <AlertBanner>Release failed: image pull backoff on web-1.</AlertBanner>
      <AlertBanner tone="blocking">
        A database password is written into the file in plain text. Move it to a secret before deploying.
      </AlertBanner>
      <AlertBanner tone="info">Host port bindings were ignored. Stackbox assigns the route itself.</AlertBanner>
    </div>
  ),
}
