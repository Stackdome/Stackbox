...
/**
 * **Bottom right, 380 wide.** The corner has no chrome to be mistaken for.
 *
...
>(({ className, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(
        // **One toast, not four.** White surface, `line/subtle` hairline, and
        // the tone lives in the glyph alone. A tinted border per tone would
        // say the severity twice (§7, §11).
        //
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      // In the flow, on the board's 8 gap: no `pr-4` needed to dodge it.
      //
