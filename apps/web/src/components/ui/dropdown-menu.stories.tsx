 ...
 *
 * Everything below is the menu itself, not a screen that contains one.
 */
const meta = {
...
/**
 * **A menu floats at `lg`, like every other menu** (§5). `Popover`, the
 * select panel and this component's own submenu are all at `lg`, so a
 * submenu never casts a deeper shadow than the menu that opened it.
 */
 ...
 * two states of one object), and the reason travels with it rather than
  ...
  render: () => (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-64">
        ...
        <DropdownMenuItem>Copy the release webhook URL to the clipboard</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  ),
}
