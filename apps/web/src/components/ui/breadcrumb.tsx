...
/**
 * The crumb you are already on. `asChild` is not decoration: the last crumb
 * is the PAGE TITLE (§12a), and on a detail page that title is an object's
 * name that can be renamed, so this slot has to be able to host the rename
 * control itself rather than sit beside it.
 *
