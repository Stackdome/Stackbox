 ...
 *
 * `Popover`, `SelectContent` and this component's own `SubContent` are all at
 * `lg`, so a submenu, which floats one layer above the menu that opened it,
 * never casts a deeper shadow than the menu itself. §5 puts popovers,
 * dropdowns and select panels on one rung.
 */
 ...
 *
 * **It lives here rather than at the call site.** A glyph written by hand at
 * each call site next to a Status or Sort trigger is a chance for the next
 * one to differ.
 *
