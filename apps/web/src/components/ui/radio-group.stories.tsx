...
// Unchecked border uses `border-border-strong` (already the primitive's
// default) rather than the plain `--border` hairline: against `bg-card` and
// table-row surfaces the 11%-alpha hairline nearly vanishes at the 16px dot
// size, so the primitive keeps the stronger 18% tier rather than the page
// patching it per call site.
const meta = {
