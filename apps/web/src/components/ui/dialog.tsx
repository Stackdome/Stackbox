...
// Three widths only: a raw `sm:max-w-*` at a call site invites thirteen more.
...
// whole body. Without the wrapper the footer break sits at the same level as
// the header break and the model collapses.
