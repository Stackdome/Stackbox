...
const meta = {
  ...
  component: Input,
  tags: ['ai-generated'],
  args: { placeholder: 'my-instance-name' },
...
export const Filled: Story = { args: { defaultValue: 'my-first-instance' } }
/**
...
export const Disabled: Story = {
  args: { disabled: true, defaultValue: 'my-first-instance' },
  play: async ({ canvas }) => {
    const input = canvas.getByRole('textbox')
    const style = getComputedStyle(input)
...
export const LongValueOverflow: Story = {
  args: {
    defaultValue:
      'this-is-an-unreasonably-long-instance-name-that-should-not-blow-out-the-pill-shaped-field-layout',
  },
  render: (args) => (
    <div className="w-64">
      <Input {...args} />
