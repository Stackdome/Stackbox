...
const selectTriggerVariants = cva(
  // **A select is a raised card**: the sheet ground, the hairline, and
  // `elevation/sm`. It reads as a small surface standing on the page, and
  // hover lifts the LINE instead of the fill.
  //
...
export {
  ...
  //
  // A combobox built on Popover + Command cannot use `SelectTrigger`, since
  // Radix's trigger belongs to Radix's Select, but it is the same control to
  // a reader: a field that opens a list. The look is the export; the
  // machinery stays theirs.
